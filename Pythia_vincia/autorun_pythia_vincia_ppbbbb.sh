...
outpath="/home/alan/ML_Analysis/Universality_DNN_DiHiggs/Out/Pythia_vincia_QCD"
process="ppbbbb"
...
do
    ...
    cd $pythiapath
    nohup ./main42 $pythiacmndpath/"$process".cmnd $mcdatapath/Pythia_vincia/"$process"_pythia_vin_"$i".hepmc > $outpath/"$process"_"$i".log &
