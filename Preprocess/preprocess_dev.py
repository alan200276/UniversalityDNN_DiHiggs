...
print("\n")
np.savez(imagespath +str(PRO)+"_"+str(GEN)+"_"+str(SHO)+"_"+str(file_number)+"_untrimmed_leading.npz", 
...
print("There are {} jet images.".format(len(jetimage_list)))
print("\n")
np.savez(imagespath +str(PRO)+"_"+str(GEN)+"_"+str(SHO)+"_"+str(file_number)+"_untrimmed_subleading.npz", 
           jet_images = jetimage_list)
