...
outpath="/home/alan/ML_Analysis/Universality_DNN_DiHiggs/Out/Pythia_default_H"
...
do
    ...
    cd $pythiapath
    nohup ./main42 $pythiacmndpath/ppHhh.cmnd $mcdatapath/Pythia_default/ppHhh_pythia_def_"$i".hepmc > $outpath/ppHhh_"$i".log &
