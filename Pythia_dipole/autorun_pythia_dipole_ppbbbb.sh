...
pythiacmndpath="/home/alan/ML_Analysis/Universality_DNN_DiHiggs/Pythia_dipole"
mcdatapath="/home/u5/Universality_DiHiggs"
outpath="/home/alan/ML_Analysis/Universality_DNN_DiHiggs/Out/Pythia_dipole_QCD"
process="ppbbbb"
...
do
    ...
    cd $pythiapath
    nohup ./main42 $pythiacmndpath/"$process".cmnd $mcdatapath/Pythia_dipole/"$process"_pythia_dip_"$i".hepmc > $outpath/"$process"_"$i".log &
